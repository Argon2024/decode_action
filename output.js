//Tue Nov 12 2024 00:53:26 GMT+0000 (Coordinated Universal Time)
...
(() => {
  ...
  function g() {
    ...
    var a6 = {
      ...
      UrHJa: "zwkNM",
      cXqhZ: "normal",
      uOyaT: "GeneratorFunction",
      Hwyxr: "https://mirror.ghproxy.com/https://raw.githubusercontent.com/xzxxn777/Surge/main/Utils/Utils.js",
      sSjGS: function (aD) {
        return aD();
      },
      ...
      bFmZR: "JHrTk",
      yTEhJ: "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQD6XO7e9YeAOs+cFqwa7ETJ+WXizPqQeXv68i5vqw9pFREsrqiBTRcg7wB0RIp3rJkDpaeVJLsZqYm5TW7FWx/iOiXFc+zCPvaKZric2dXCw27EvlH5rq+zwIPDAJHGAfnn1nmQH7wR3PCatEIb8pz5GFlTHMlluw4ZYmnOwg+thwIDAQAB",
      Jsvpr: "post%%/web/oauth/credential_auth?",
      ...
      DbOzF: "The iterator does not provide a '",
      MPsaI: "' method",
      ...
      GZOOe: "try statement without catch or finally",
      ...
      TdtQN: "KYDMR",
      cuTAT: "Generator is already running",
      WWxuK: "nyUVg",
      MWIcw: "DjVvt",
      HolmJ: "KtcVq",
      ...
      EmXfV: "Tejvp",
      yknRW: "0|3|5|2|4|1",
      GCiqZ: "iterator result is not an object",
    ...
    function ah(aG, aH, aI, aJ) {
      {
        var aM = aH && aH.prototype instanceof ao ? aH : ao;
              ...
              for (;;) {
                switch (bi.prev = bi.next) {
                  ...
                  case 73:
                    ...
                    bi.next = 77;
                    return N("/lotteryhy/designh5/client/activity/aa9593c76ca0c503b983ba26e2bc5a15");
                  case 77:
                    aq = bi.sent;
                  ...
                  case 80:
                    ...
                    bi.next = 83;
                    return P("/lotteryhy/api/client/cj/awd/drw/aa9593c76ca0c503b983ba26e2bc5a15", {});
                  case 83:
                    as = bi.sent;
                  ...
                  case 88:
                    bi.next = 90;
                    return N("/lotteryhy/api/client/cj/my/prize/info/aa9593c76ca0c503b983ba26e2bc5a15?page=1&count=100");
                  case 90:
                    at = bi.sent;
                    au = c(at.data);
                    bi.prev = 92;
        ...
        for (;;) {
          switch (ab.prev = ab.next) {
            case 0:
              return ab.abrupt("return", new Promise(function (ad) {
                var af = {
                  url: "https://active.hndachao.cn".concat(a9),
                  headers: {
                    "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
